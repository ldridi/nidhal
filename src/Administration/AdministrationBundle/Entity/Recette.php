...
class Recette
{
     ...
     * Set latRecette
     *
     * @param string $latRecette
     *
     * @return Recette
     */
    public function setLatRecette($latRecette)
    {
        $this->latRecette = $latRecette;
     ...
     * @return string
     */
    public function getLatRecette()
    {
        return $this->latRecette;
    }

    /**
     * Set longRecette
     *
     * @param string $longRecette
     *
     * @return Recette
     */
    public function setLongRecette($longRecette)
    {
        $this->longRecette = $longRecette;
     ...
     * @return string
     */
    public function getLongRecette()
    {
        return $this->longRecette;
    }
}
